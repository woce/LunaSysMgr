...
CONFIG_BUILD += opengl openglcomposited

SOURCES += HostQtDesktop.cpp FlickGestureRecognizer.cpp SoundPlayerDummy.cpp PreKeymap.cpp
HEADERS += HostQtDesktop.h FlickGestureRecognizer.h FlickGesture.h SoundPlayerDummy.h PreKeymap.h
...
INCLUDEPATH += \
	...
	$$(LUNA_STAGING)/include/webkit \
	$$(LUNA_STAGING)/include/webkit/npapi \
	$$WEBKIT_PATH/WebKit/palm/webkit \
	$$WEBKIT_PATH/WebKit/palm/Api \
	$$WEBKIT_PATH/WebKit/palm/WebCoreSupport \
	$$WEBKIT_PATH/WebCore/platform/graphics/pg \
	$$(LUNA_STAGING)/include/Piranha \
