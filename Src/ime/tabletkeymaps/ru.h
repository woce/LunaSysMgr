...
#ifndef KEYBOARD_RU_H
#define KEYBOARD_RU_H
#include "../TabletKeymap.h"
#include "common_keys.h"
static TabletKeymap::LayoutFamily sLayoutRussian("Russian", "ru");
static TabletKeymap::constUKeyArray sRussian_DotCom_Extended = { cKey_DotCom, cKey_DotNet, cKey_DotOrg, cKey_DotEdu, cKey_None };
...
#define RU_QWERTY_BOTTOM_ROW_URL \
									...
									KEY_3(1, cKey_DotCom, cKey_DotCom, sRussian_DotCom_Extended),\
									KEY_3(1, Qt::Key_Apostrophe, Qt::Key_QuoteDbl, sSingleAndDoubleQuote_extended),\
									KEY_3(1, Qt::Key_Minus, Qt::Key_Underscore, sMinusUnderscore_extended),\
									KEY_3(1, cKey_Hide, cKey_Hide, sHide_extended),\
									NOKEY_3
...
static TabletKeymap::Keymap sRuQwerty(&sLayoutRussian, "йцукен", IME_KBD_LANG_English, IME_KBD_SEC_REGQwerty,
                                                "+ = [  ]" /* Spaces are "Unicode Character 'HAIR SPACE' (U+200A) ' ' " */, "йцукен" /* Spaces are "Unicode Character 'HAIR SPACE' (U+200A) ' ' " */,
                                                0, 1, 10, 2, false, sRuQwertyLayout, sRuQwertyBottomRow_default, sRuQwertyBottomRow_url, sRuQwertyBottomRow_email);
#endif // KEYBOARD_RU.H
