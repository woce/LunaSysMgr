...
public:
	...
	bool                atlasEnabled;
	int					emulatedCardWidth;
	int					emulatedCardHeight;
	...
	bool cesDemoBuild;
	std::string cesGestureRepeaterIp;
	int cesGestureRepeaterPort;
	bool enableGestureRepeater;
