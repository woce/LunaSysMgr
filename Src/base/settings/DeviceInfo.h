...
public:
	...
	std::string jsonString(Window::Type appType);
...
private:
	...
	std::string m_emuJsonString;

	int m_screenWidth;
	int m_screenHeight;

	int m_emuScreenWidth;
	int m_emuScreenHeight;
	...
	int m_emuMinimumCardWidth;
	int m_emuMinimumCardHeight;
	int m_emuMaximumCardWidth;
	int m_emuMaximumCardHeight;


	int m_touchableRows;
	int m_emuTouchableRows;
