...
class CoreNaviLeds {
    ...
    private:
        ...
        void initializeEffect(led_controller_effect_type_t effect_type, int led);
        void finalizeAndExecute();

        hal_led_controller_core_configuration_handle_t m_config;
        led_controller_effect_t m_effect;

        bool m_lightbarEnabled;
        hal_device_handle_t m_device;
#endif
