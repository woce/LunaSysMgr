...
public:
	...
	virtual PIpcBuffer* getIpcTransition() const { return m_transitionBuffer; }
	virtual void setIpcTransitionBuffer(PIpcBuffer* buffer) { m_transitionBuffer = buffer; }
	...
	void onSceneTransitionPrepare(int width, int height);
	void onSceneTransitionPrepareCrossApp();
	void onSceneTransitionCancel();
