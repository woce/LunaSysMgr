...
void HostWindow::onMessageReceived(const PIpcMessage& msg)
{
	...
	IPC_BEGIN_MESSAGE_MAP(HostWindow, msg, msgIsOk)
		...
		IPC_MESSAGE_HANDLER(ViewHost_SceneTransitionPrepare, onSceneTransitionPrepare)
		IPC_MESSAGE_HANDLER(ViewHost_SceneTransitionRun, sceneTransitionRun)
		IPC_MESSAGE_HANDLER(ViewHost_SceneTransitionCancel, onSceneTransitionCancel)
		IPC_MESSAGE_HANDLER(ViewHost_SceneTransitionPrepareCrossApp, onSceneTransitionPrepareCrossApp)
...
void HostWindow::onSceneTransitionPrepare(int width, int height)
{
	if (m_data)
		m_data->onSceneTransitionPrepare(width, height);
	sceneTransitionPrepare();
}

void HostWindow::onSceneTransitionCancel()
{
	sceneTransitionCancel();
}

void HostWindow::onSceneTransitionPrepareCrossApp()
{
	sceneTransitionPrepareCrossApp();
}
