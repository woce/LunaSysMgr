...
public:
    ...
    bool updateHalWithLocation(double latitude, double longitude);
...
private:
    ...
    static bool backlightOnCallback (LSHandle* sh, LSMessage* message, void* ctx);
    void backlightOff();
    static bool backlightOffCallback (LSHandle* sh, LSMessage* message, void* ctx);
