...
public:
	...
	virtual WebAppBase* createWebApp(Window::Type winType, WebPage* page, PIpcChannel* channel, ApplicationDescription* desc = 0) = 0;
	...
	static std::string nameForWindowType(Window::Type winType);
