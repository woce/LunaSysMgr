...
#if 0
	// For CES Demo build disable first use completely
	if (Settings::LunaSettings()->cesDemoBuild) {
		Settings::LunaSettings()->uiType = Settings::UI_LUNA;
		s_appToLaunchStr = NULL;
	}
#endif
...
/**
 * Forks the process, runs RunWebAppManagerTask, and sets up pipes for IPC
 * 
